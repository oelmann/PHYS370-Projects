...
void DefineField(){
  for (int x=0; x<xdim; x++)
    for (int y=0; y<ydim; y++){
      ...
      if (y-(3*ydim/10)<0){
	field[x][y]=2;
	if (x-(2*xdim/10)<0 && x-(xdim/10)>0  && y-(ydim/20)>0) field[x][y]=1;
	if (x-(4*xdim/10)<0 && x-(3*xdim/10)>0  && y-(ydim/20)>0) field[x][y]=1;
	if (x-(6*xdim/10)<0 && x-(5*xdim/10)>0  && y-(ydim/20)>0) field[x][y]=1;
	if (x-(8*xdim/10)<0 && x-(7*xdim/10)>0  && y-(ydim/20)>0) field[x][y]=1;
	if (x-(9*xdim/10)>0  && y-(ydim/20)>0) field[x][y]=1;
      }
...
void init(){
  ...
  for (int x=0; x<xdim; x++)
    for (int y=0; y<ydim; y++){
      ...
      if (y-(3*ydim/10)<0){
	phi[x][y]=2;
	if (x-(2*xdim/10)<0 && x-(xdim/10)>0  && y-(ydim/20)>0) phi[x][y]=1;
	if (x-(4*xdim/10)<0 && x-(3*xdim/10)>0  && y-(ydim/20)>0) phi[x][y]=1;
	if (x-(6*xdim/10)<0 && x-(5*xdim/10)>0  && y-(ydim/20)>0) phi[x][y]=1;
	if (x-(8*xdim/10)<0 && x-(7*xdim/10)>0  && y-(ydim/20)>0) phi[x][y]=1;
	if (x-(9*xdim/10)>0  && y-(ydim/20)>0) phi[x][y]=1;
      }
